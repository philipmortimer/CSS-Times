...
const para1 = new Paragraph(
  <p> 
    <strong>
    Bristol, UK: In a surprising turn of events, students at the University of Bristol are planning a strike over a seemingly
     trivial issue - the door to the "MVB Linux Lab" not working.
    </strong>
  </p>,
