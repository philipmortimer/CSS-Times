...
const mainPhoto = new Picture('/CSS-Times/Images/Articles/DavidBernhard4Fa/KatiePriceImageMain.jpg',
...
const para5 = new Paragraph(
  ...
  new Picture('/CSS-Times/Images/Articles/DavidBernhard4Fa/katepriceinsta.png', 
